...
const exerciseCases: ExerciseCase[] = [
  ...
  {
    name: 'stagnation : deux séances identiques ne font pas encore un plateau',
    today: '2026-04-28',
    defaultReps: 6,
    defaultWeight: 86,
    weightUnit: 'kg',
  ...
  {
    name: 'stagnation : trois séances identiques d’affilée font un plateau',
    today: '2026-05-05',
    defaultReps: 6,
    defaultWeight: 86,
    weightUnit: 'kg',
    ...
    isDumbbell: false,
    sets: [
      set(1, 6, 86, day('2026-04-20')),
      set(2, 6, 86, day('2026-04-27')),
      set(3, 6, 86, day('2026-05-04')),
    ],
  },
  {
    name: 'stagnation : la même charge tenue plus facilement n’est pas un plateau',
    today: '2026-05-05',
    defaultReps: 6,
    defaultWeight: 86,
    weightUnit: 'kg',
    ...
    isDumbbell: false,
    sets: [
      set(1, 6, 86, day('2026-04-20'), { rpe: 9 }),
      set(2, 6, 86, day('2026-04-27'), { rpe: 9 }),
      set(3, 6, 86, day('2026-05-04'), { rpe: 8 }),
    ],
  },
  {
    name: 'fatigue : même performance, effort perçu un cran plus haut',
    today: '2026-04-28',
    defaultReps: 6,
    defaultWeight: 86,
    weightUnit: 'kg',
    restSeconds: 180,
    isDumbbell: false,
    sets: [set(1, 6, 86, day('2026-04-20'), { rpe: 8 }), set(2, 6, 86, day('2026-04-27'), { rpe: 9 })],
  },
  {
    name: 'progression : deux séances tenues avec de la réserve, la charge peut monter',
    today: '2026-04-28',
    defaultReps: 8,
    defaultWeight: 60,
    weightUnit: 'kg',
    ...
    isDumbbell: false,
    sets: [
      set(1, 8, 70, day('2026-04-13', 18, 0), { rpe: 7 }),
      set(2, 8, 70, day('2026-04-13', 18, 3), { rpe: 8 }),
      set(3, 8, 70, day('2026-04-13', 18, 6), { rpe: 8 }),
      set(4, 8, 70, day('2026-04-20', 18, 0), { rpe: 7 }),
      set(5, 8, 70, day('2026-04-20', 18, 3), { rpe: 7 }),
      set(6, 8, 70, day('2026-04-20', 18, 6), { rpe: 8 }),
    ],
  },
  {
    name: 'progression : une série au-delà de RPE 8 et rien n’est suggéré',
    today: '2026-04-28',
    defaultReps: 8,
    defaultWeight: 60,
    weightUnit: 'kg',
    ...
    isDumbbell: true,
    sets: [
      set(1, 8, 36, day('2026-04-13', 18, 0), { rpe: 7 }),
      set(2, 8, 36, day('2026-04-13', 18, 3), { rpe: 8 }),
      set(3, 8, 36, day('2026-04-13', 18, 6), { rpe: 8 }),
      set(4, 8, 36, day('2026-04-20', 18, 0), { rpe: 7 }),
      set(5, 8, 36, day('2026-04-20', 18, 3), { rpe: 8.5 }),
      set(6, 8, 36, day('2026-04-20', 18, 6), { rpe: 8 }),
    ],
  },
  {
    ...
    sets: [
      set(1, 8, 60, day('2026-04-20', 18, 0)),
      set(2, 8, 60, day('2026-04-20', 18, 4, 20)),
      set(3, 8, 60, day('2026-04-20', 18, 8, 50)),
      set(4, 8, 62, day('2026-04-27', 18, 0)),
      set(5, 8, 62, day('2026-04-27', 18, 4, 40)),
      set(6, 8, 62, day('2026-04-27', 18, 9, 0)),
    ],
  },
  {
    ...
    seances: [
      {
        ...
        exercises: [
          exercise('developpe', 'Développé', [
            set(1, 6, 86, day('2026-04-06')),
            set(2, 6, 86, day('2026-04-13')),
            set(3, 6, 86, day('2026-04-20')),
          ]),
